...
urlpatterns = [
            ...
            # path('listar_tratamientos_asignados/<int:pk>', DetalleTratamientosAsignados.as_view(),  name="listar_tratamientos_asignados"),
            # path('tratamientos_asignados/<str:numero_documento>', mostrar_tratamiento_asignado,  name="tratamientos_asignados"),
]